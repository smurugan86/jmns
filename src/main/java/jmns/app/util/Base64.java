...
public class Base64 {
	...
	public static void main(String[] args) {
		// String toEncode = "tim@timco1.com:catbutt";
		// String toEncode =
		// "nametest@vendormate.vdm:990e15612fee144f8ca5aa5f83b98f45";
		// String toEncode =
		// "thebrandbank@vendormate.vdm:990e15612fee144f8ca5aa5f83b98f45";
		// String toEncode =
		// "crhs@vendormate.vdm:990e15612fee144f8ca5aa5f83b98f45";
		//String toEncode = "mhbuyer@vendormate.vdm:990e15612fee144f8ca5aa5f83b98f45";

		String toEncode = "ccxcmuser:ccxcmpass";
		// String toEncode =
		// "abc12112@test.vm:990e15612fee144f8ca5aa5f83b98f45";

		
		String encoded = Base64.encodeObject(toEncode);
		System.out.println(toEncode + "=" + encoded);
		System.out.println("encoded" + "=" + Base64.decodeToObject(encoded));
		// System.out.println("encoded" + "=" +
		// Base64.decodeToObject("rO0ABXQAPmJ1eWVyX21heW9AbW9va2FtYmlrYWluZm8uY29tOjk5MGUxNTYxMmZlZTE0NGY4Y2E1YWE1ZjgzYjk4ZjQ1"));

		// String toEncode = "tim@timco1.com:catbutt";

		// String toEncode = "ahmchealth@vendormate.vdm:gltd123";
		// String toEncode = "ahmchealth@vendormate.vdm";
		//
		//
		//
		// String encoded = Base64.encodeObject(toEncode);
