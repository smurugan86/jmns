 ...
 <form method="post" action="/jmns/login">
      <table border="0">
        <tr style="padding: 10px 14px 10px;">
          ...
          <td>
            <input type="text" name="username" value="${username}" class="box" style="width: 400px;" maxlength="50">
          </td>
          <td class="error">
          </td>
        </tr>
<tr>
        ...
        <tr style="padding: 10px 14px 10px;">
          ...
          <td>
            <input type="password" name="password" value="" class="box" style="width: 400px;" maxlength="50">
          </td>
          <td class="error">	    		
